<template>
  <form @submit.prevent="submitForm" class="space-y-6">
    ...
    <div>
      ...
      <input type="text" name="nre" id="nre" placeholder="8754214" class="form-modal-input" required v-model="nre.val" />
    </div>
    <div>
      <label for="year" class="form-modal-label">Curso</label>
      <input type="text" name="year" id="year" placeholder="2022/2023" class="form-modal-input" required v-model="year.val" />
    </div>
    <div>
    ...
    <div>
      ...
      <input type="number" name="hours" id="hours" placeholder="400" class="form-modal-input" required v-model="hours.val" />
    </div>
